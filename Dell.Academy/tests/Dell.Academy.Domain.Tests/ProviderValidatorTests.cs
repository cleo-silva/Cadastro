...
namespace Dell.Academy.Domain.Tests
{
    ...
    public class ProviderValidatorTests
    {
        ...
        {
            // Arrange
            var provider = new Provider("Test Name", _faker.Company.Cnpj(), null, GenderType.None, true, null);
        ...
        {
            // Arrange
            var provider = new Provider("Test Name", _faker.Person.Cpf(), null, GenderType.None, true, null);
        ...
        public void ReceiveAnEmptyProviderName_ShouldValidateProvider()
        {
            ...
            // Arrange
            var provider = new Provider(string.Empty, _faker.Company.Cnpj(), null, GenderType.None, true, null);
        ...
        {
            // Arrange
             var provider = new Provider("P1", _faker.Company.Cnpj(), null, GenderType.None, true, null);
        ...
        {
            // Arrange
            var provider = new Provider(_faker.Random.AlphaNumeric(31), _faker.Company.Cnpj(), null, GenderType.None, true, null);
